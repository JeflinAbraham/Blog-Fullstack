...
function Signup() {
  ...
  return (
    <div className='min-h-screen'>
      <div className='flex p-16 max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5 shadow-lg shadow-slate-700 dark:shadow-orange-700 dark:shadow-xl  mt-20'>
        {/* left */}
